...
/*   Updated: 2023/02/18 12:08:27 by hmaciel-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_elements_path(t_root *root)
{
	...
	root->path.patrol1 = "./textures/patrol/patrol1.xpm";
	root->path.patrol2 = "./textures/patrol/patrol2.xpm";
	root->path.patrol3 = "./textures/patrol/patrol3.xpm";
}
